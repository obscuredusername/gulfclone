  ...
  return (
    <div className='container mt-5'>
      ...
      <div className='row mt-3 bodymain'>
        ...
        <div className='col-md-6 col-lg-3 p1'>
          {body && body[1] && body[1].map(post => (
            <div className='p-3 p2' key={post.id}>
              <h3>{post.title}</h3>
              <img className='img-fluid pimg' src={post.picture} alt={post.title} />
            </div>
          ))}
          {body && body[2] && body[2].map(post => (
      ...
      <Body2 body={body[3]} />
      <div className='row'>
        <Postlist className={'col-md-6 col-lg-3'} body={body[4]} />
        <Postlist className={'col-md-6 col-lg-2'} body={body[5]} />
      </div>
      <div className='row'>
